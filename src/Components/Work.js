...
function Work({ position, company, location, type, duration }) {
  return (
    <article className="py-5 border-b border-gray-200 dark:border-white/10 last:border-0">
      <div className="flex justify-between items-start gap-3">
        <h1 className="text-sm md:text-base font-medium text-dark-heading dark:text-light-heading">{position}</h1>
        <span className="shrink-0 text-xs bg-green-50 dark:bg-green-900/30 text-green-700 dark:text-green-400 border border-green-200 dark:border-green-700/50 rounded-full px-3 py-0.5">
          {type}
        </span>
      </div>
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-1 mt-2">
        <div className="flex flex-wrap gap-x-4 gap-y-1">
          <div className="flex items-center gap-1">
            <svg className="fill-dark-content dark:fill-light-content shrink-0" width="13" height="13" viewBox="0 0 16 12">
            ...
            <p className="text-content text-xs font-light">{company}</p>
          </div>
          <div className="flex items-center gap-1">
            <svg className="fill-dark-content dark:fill-light-content shrink-0" width="13" height="13" viewBox="0 0 16 12">
            ...
            <p className="text-content text-xs font-light">{location}</p>
          </div>
        </div>
        <p className="text-content text-xs font-light shrink-0">{duration}</p>
      </div>
    </article>
  );
}
